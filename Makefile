...
TSXBENCHS = src/tsx/linkedlist-lazy src/tsx/linkedlist-harris-tsx src/tsx/linkedlist-harris-cas src/tsx/skiplist-herlihy_lb src/tsx/skiplist-fraser src/tsx/skiplist-fraser-cas src/tsx/bst-tk src/tsx/hashtable-lazy src/tsx/skiplist-fraser-tsx src/tsx/bst-aravind-cas src/tsx/bst-aravind-tsx src/tsx/hashtable-harris src/tsx/skiplist-pugh src/tsx/linkedlist-pugh src/tsx/hashtable-java src/tsx/hashtable-copy src/tsx/linkedlist-new-lf src/tsx/linkedlist-new-half src/tsx/linkedlist-new-full src/tsx/linkedlist-new-updates-lf src/tsx/linkedlist-new-updates-half src/tsx/linkedlist-new-updates-full
...
tsxsl_fraser:
	$(MAKE) "LOCK=TSX" src/tsx/skiplist-fraser
