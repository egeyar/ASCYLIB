...
TSXBENCHS = src/tsx/linkedlist-lazy src/tsx/linkedlist-harris-tsx src/tsx/linkedlist-harris-cas src/tsx/skiplist-herlihy_lb src/tsx/skiplist-fraser-cas src/tsx/bst-tk src/tsx/hashtable-lazy src/tsx/skiplist-fraser-tsx src/tsx/bst-aravind-cas src/tsx/bst-aravind-tsx src/tsx/hashtable-harris src/tsx/skiplist-pugh src/tsx/linkedlist-pugh src/tsx/hashtable-java src/tsx/hashtable-copy src/tsx/linkedlist-new-lf src/tsx/linkedlist-new-half src/tsx/linkedlist-new-full src/tsx/hashtable-new-full src/tsx/hashtable-new-half src/tsx/hashtable-new-lf src/tsx/bst-new src/tsx/bst-new-lf src/tsx/skiplist-new-lf src/tsx/skiplist-new-half src/tsx/skiplist-new-full src/tsx/linkedlist-tsx src/tsx/linkedlist-generic src/tsx/bst-generic src/tsx/skiplist-generic
...
.PHONY:	clean all external $(BENCHS) $(LBENCHS) $(NOISE) $(TESTS) $(SEQBENCHS) $(TSXBENCHS)

default: lockfree tas seq tsx

all:	lockfree tas seq external tsx
...
tsxbst_tk:
	$(MAKE) "LOCK=TSX" src/tsx/bst-tk

tsxbst_new:
	$(MAKE) "LOCK=TSX" src/tsx/bst-new

lfbst_new:
	$(MAKE) "LOCK=TSX" src/tsx/bst-new-lf

tsxbst_generic:
	$(MAKE) "LOCK=TSX" src/tsx/bst-generic
...
tsxbst: bst_tk tsxbst_tk bst_aravind tsxbst_aravind_cas tsxbst_aravind_tsx tsxbst_new lfbst_new tsxbst_generic 
...
tsxsl_herlihy_lb:
	$(MAKE) "LOCK=TSX" src/tsx/skiplist-herlihy_lb

tsxsl_fraser_cas:
	$(MAKE) "LOCK=TSX" src/tsx/skiplist-fraser-cas

tsxsl_fraser_tsx:
	$(MAKE) "LOCK=TSX" src/tsx/skiplist-fraser-tsx

lfsl_new:
	$(MAKE) "STM=LOCKFREE" src/tsx/skiplist-new-lf

tsxsl_new_half:
	$(MAKE) "LOCK=TSX" src/tsx/skiplist-new-half

tsxsl_new_full:
	$(MAKE) "LOCK=TSX" src/tsx/skiplist-new-full

tsxsl_generic:
	$(MAKE) "LOCK=TSX" src/tsx/skiplist-generic

sl:	seqsl lfsl_fraser lfsl_herlihy_lf lbsl_pugh lbsl_herlihy_lb lbsl_optik lbsl_optik1 lbsl_optik2
tsxsl:	tsxsl_herlihy_lb tsxsl_fraser_tsx lbsl_herlihy_lb lfsl_fraser lbsl_pugh tsxsl_pugh lfsl_new tsxsl_new_half tsxsl_new_full tsxsl_generic
...
lfll_new:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-new-lf

tsxll_new_half:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-new-half

tsxll_new_full:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-new-full

tsxll_tsx:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-tsx

tsxll_generic:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-generic
...
tsxll: tsxll_lazy tsxll_harris_tsx tsxll_harris_cas lfll_harris lbll_lazy lbll_pugh tsxll_pugh tsxll_new_half tsxll_new_full lfll_new tsxll_tsx tsxll_generic
...
tsxht_lazy:
	$(MAKE) "LOCK=TSX" src/tsx/hashtable-lazy
...
tsxll_lazy:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-lazy

tsxll_harris_tsx:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-harris-tsx

tsxll_harris_cas:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-harris-cas
...
tsxht_new_full:
	$(MAKE) "LOCK=TSX" src/tsx/hashtable-new-full

tsxht_new_half:
	$(MAKE) "LOCK=TSX" src/tsx/hashtable-new-half

tsxht_new_lf:
	$(MAKE) "LOCK=TSX" src/tsx/hashtable-new-lf
...
tsxht:  lbht_lazy lfht tsxht_lazy tsxht_harris htjava tsxht_java htcopy tsxht_copy tsxht_new_full tsxht_new_half tsxht_new_lf
...
clean:
	...
	$(MAKE) -C src/linkedlist-optik_gl clean
	...
	$(MAKE) -C src/tsx/linkedlist-lazy clean
	$(MAKE) -C src/tsx/linkedlist-harris-tsx clean
	$(MAKE) -C src/tsx/linkedlist-harris-cas clean
	$(MAKE) -C src/tsx/linkedlist-pugh clean
	$(MAKE) -C src/tsx/linkedlist-new-lf clean
	$(MAKE) -C src/tsx/linkedlist-new-half clean
	$(MAKE) -C src/tsx/linkedlist-new-full clean
	$(MAKE) -C src/tsx/linkedlist-tsx clean
	$(MAKE) -C src/tsx/linkedlist-generic clean
	...
	$(MAKE) -C src/tsx/skiplist-new-lf clean
	$(MAKE) -C src/tsx/skiplist-new-half clean
	$(MAKE) -C src/tsx/skiplist-new-full clean
	$(MAKE) -C src/tsx/skiplist-generic clean
	$(MAKE) -C src/tsx/bst-tk clean
	$(MAKE) -C src/tsx/bst-aravind-cas clean
	$(MAKE) -C src/tsx/bst-aravind-tsx clean
	$(MAKE) -C src/tsx/bst-new clean
	$(MAKE) -C src/tsx/bst-new-lf clean
	$(MAKE) -C src/tsx/bst-generic clean
	...
	$(MAKE) -C src/tsx/hashtable-new-full clean
	$(MAKE) -C src/tsx/hashtable-new-half clean
	$(MAKE) -C src/tsx/hashtable-new-lf clean
	rm -rf build
