...
TSXBENCHS = src/tsx/linkedlist-lazy src/tsx/linkedlist-harris src/tsx/linkedlist-harris-tsx src/tsx/linkedlist-harris-cas src/tsx/skiplist-herlihy_lb src/tsx/skiplist-fraser src/tsx/bst-tk src/tsx/bst-tk_fallback src/tsx/hashtable-lazy
...
tsxbst_tk2:
	$(MAKE) "LOCK=TSX" src/tsx/bst-tk_fallback
...
tsxsl:	tsxsl_herlihy_lb tsxsl_fraser
...
tsxll: tsxll_lazy tsxll_harris tsxll_harris_tsx tsxll_harris_cas 
...
tsxll_harris:
	$(MAKE) "LOCK=TSX" src/tsx/linkedlist-harris
...
clean:
	...
	$(MAKE) -C src/tsx/bst-tk_fallback clean
